...
export function IntroGraphic(): JSX.Element {
    return (
        <div className="flex flex-row space-x-4 circle-container">
                <Image className="circle" src={happyFaceOne} alt="happy face one" width={200} height={200} />
                <Image className="circle" src={happyFaceTwo} alt="happy face two" width={200} height={200} />
                <Image className="circle" src={happyFaceThree} alt="happy face three" width={200} height={200} />
                <Image className="circle" src={happyFaceFour} alt="happy face four" width={200} height={200} />
            </div>
    );
}